...
# Tentukan tipe data kategori untuk menghemat RAM (sangat efektif!)
dtype_opt = {
...
# Automatically detect categorical/object columns (exclude date and target)
kolom_kategori = [
    c for c in df.select_dtypes(include=['object', 'category']).columns
    if c not in ['Date_of_Transfer', 'Price']
]
le = LabelEncoder()
